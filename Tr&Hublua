spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To Tr&Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Tr&Hub's Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window =
    ...
    {
        Title = "Tr&Hub",
        SubTitle = "creator by Tr & Hub | community",
        TabWidth = 160,
